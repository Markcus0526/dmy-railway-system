		...
		<form class="form-horizontal" role="form" id="validation-form">
            <div class="form-group">
                ...
                <div class="btn-group" style="float:right">
				   <a class="btn btn-info btn-white" href="<%= ViewData["rootUri"] %>Content/files/通讯录-科室干部.xls">导入格式</a>
				    ...
				    <ul class="dropdown-menu dropdown-info dropdown-menu-right">
					    <li>
						    <a href="<%= ViewData["rootUri"] %>Content/files/通讯录-科室干部.xls">下载科室干部模板</a>
					    </li>
                         <li>
						    <a href="<%= ViewData["rootUri"] %>Content/files/通讯录-车队干部.xls">下载车队干部模板</a>
					    </li>
                         <li>
						    <a href="<%= ViewData["rootUri"] %>Content/files/通讯录-列车长.xls">下载车队列车长模板</a>
					    </li>
				    </ul>
			    </div>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageScripts" runat="server">
	...
	<script type="text/javascript">
	    ...
	    function submitform() {
	        $.ajax({
	            type: "POST",
	            url: rootUri + "Contact/SubmitContactImport",
	            dataType: "json",
