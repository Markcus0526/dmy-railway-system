...
<div class="row">
	<div class="col-xs-12">
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Contact/AddContact">
	                <i class="ace-icon fa fa-plus bigger-120 blue"></i>新增通讯录
                </a>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Contact/ImportContact">
		...
		<script type="text/javascript">
			...
			.on('change', function () {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Contact/RetrieveContactList",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '';
				                rst += '<a class="btn btn-xs btn-info" href="' + rootUri + 'Contact/EditContact/' + o.aData[12] + '">' +
		            ...
		            bootbox.dialog({
		                ...
		                buttons: {
		                    ...
		                    main: {
		                        ...
		                        callback: function () {
		                            $.ajax({
		                                url: rootUri + "Contact/DeleteContact",
		                                data: {
		                                    "delids": selected_id
		                                },
		                                type: "post",
