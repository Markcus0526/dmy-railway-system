			...
			<table id="tbldata" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th style="width:150px;">诉求提出者</th>
						<th style="width:150px;">诉求类型</th>
		...
		<script type="text/javascript">
		    ...
		    jQuery(function ($) {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Opinion/RetrieveOpinionList",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = "";
				                rst += '<a class="btn btn-xs btn-white" href="' + rootUri + 'Opinion/Detail/' + o.aData[5] + '">' +
                                    '查看详情' +
                                    '</a>&nbsp;&nbsp;';
