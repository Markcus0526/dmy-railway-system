...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" id="validation-form">
			...
			<div class="form-group" >
				<label class="col-sm-2 control-label no-padding-right" for="title">任务标题：</label>
				<div class="col-sm-8">
                    <div class="clearfix" style="width:100%">
			...
			<div class="form-group" >
				<label class="col-sm-2 control-label no-padding-right" for="docno">任务号：</label>
				<div class="col-sm-8">
                    <div class="clearfix" style="width:100%">
                        <input type="text" id="docno" name="docno" placeholder="请输入任务号" class="col-xs-10 col-sm-12">
                    </div>
				</div>
			</div>

			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="starttime">开始日期<span class="red">*</span>：</label>
				<div class="col-sm-3">
                    <div class="clearfix">
				...
				<label class="col-sm-1 control-label no-padding-right" for="endtime">结束日期<span class="red">*</span>：</label>
				<div class="col-sm-3">
                    <div class="clearfix">
						<div class="input-group col-xs-10 col-sm-5">
							<input class="input-large date-picker" id="endtime" name="endtime" type="text" data-date-format="yyyy-mm-dd" value="<%= ViewData["starttime"] %>" />
							<span class="input-group-addon">
								<i class="fa fa-calendar bigger-110"></i>
							</span>
						</div>
			...
			<div class="form-group" >
				<label class="col-sm-2 control-label no-padding-right" for="contents">任务内容：</label>
				<div class="col-sm-8">
                    <div class="clearfix" style="width:100%">
...
// 	    });
	    ...
	    function redirectToListPage(status) {
	        if (status.indexOf("error") != -1) {
	            ...
	            window.location = rootUri + "Task/TaskList";
	        }
	    }
        function getSelectedCount(){
            alert( $("#receiver option[selected=selected]").length);
        }
