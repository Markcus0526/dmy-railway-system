	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" id="validation-form">
			<div class="form-group" >
				<label class="col-sm-3 control-label no-padding-right" for="teamname">车队名称：</label>
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="text" id="teamname" name="teamname" placeholder="请输入车队名称" class="input-large form-control" <% if (teaminfo != null) { %>value="<%= teaminfo.teamname %>"<% } %> />
                    </div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="text" id="sortid" name="sortid" placeholder="请输入数字" class="input-large form-control col-xs-10 col-sm-5" <% if (teaminfo != null) { %>value="<%= teaminfo.sortid %>"<% } else { %>value="1"<% } %>  />
	...
	<script type="text/javascript">
	    function redirectToListPage(status) {
	        if (status.indexOf("error") != -1) {
	            ...
	            window.location = rootUri + "Team/TeamList";
	        }
	    }
	    jQuery(function ($) {
	        $('.loading-btn')
	    ...
	    function checkTeamName() {
	        ...
	        $.ajax({
	            async: false,
	            type: "GET",
	            url: rootUri + "Team/CheckUniqueTeamname",
	            dataType: "json",
	            data: {
	                teamname: teamname,
	                uid: $("#uid").val()
