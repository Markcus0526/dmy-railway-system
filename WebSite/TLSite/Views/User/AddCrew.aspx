...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" id="validation-form">
		    ...
		    <div class="form-group" >
			    ...
			    <div class="col-sm-9" style="margin:6px 0px;">
                    <div class="clearfix">
                        ...
                        <div class="radio" style="display:inline-block">
						    <label>
							    <input name="exectype" type="radio" value="<%= ExecType.TrainCrew %>" class="ace" <% if (userinfo != null && userinfo.userkind == (int)UserKind.CREW&&userinfo.crewrole!=2) { %>checked<% } %>/>
                    ...
                    <div class="clearfix">
					    <select class="select2" id="parentid" name="parentid" data-placeholder="请选择部门">
                             <% if (ViewData["parentlist"] != null) {
                                   ...
                                   else if (userinfo != null && userinfo.exectype != ExecType.SectorExec)
                                   {
		    ...
		    <div class="form-group exe <% if ((userinfo != null && userinfo.exectype != ExecType.TeamExec)||(userinfo != null && userinfo.exectype != ExecType.SectorExec)) { %>hide<% } %>">
		    ...
		    <div class="form-group crew <% if (userinfo==null||(userinfo != null && userinfo.userkind != (int)UserKind.CREW&&userinfo.crewrole!=2)) { %>hide<% } %>" >
			    <label class="col-sm-3 control-label no-padding-right" style="margin:6px 0px" for="execrole" >职务：</label>
			    <div class="col-sm-9" style="margin:6px 0px;">
                    <div class="clearfix">
                        <select class="select2 " id="crewrole" name="crewrole" data-placeholder="请选择职务" >
                            <% if (ViewData["crewrole"] != null){
                                //   var groupinfo = (tbl_traingroup)ViewData[""];
                                    ...
                                    { %>
                                    <option value="<%= item.uid %>" <% if (userinfo != null && item.uid == userinfo.crewrole) { %>selected<% } %>><%= item.rolename %></option>
                                    <% }                                       
                                %>
                            <% 
                                }  %>
