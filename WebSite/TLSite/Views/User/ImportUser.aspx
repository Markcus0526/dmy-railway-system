		...
		<form class="form-horizontal" role="form" id="validation-form">
            <div class="form-group">
                ...
                <div class="btn-group" style="float:right">
				    <a class="btn btn-info btn-white" href="<%= ViewData["rootUri"] %>Content/files/干部样例表.xls">下载xls导入格式</a>	
				    ...
				    <ul class="dropdown-menu dropdown-info dropdown-menu-right">
					    <li>
						    <a href="<%= ViewData["rootUri"] %>Content/files/干部样例表.xls">干部样例表</a>
					    </li>
					    <li>
						    <a href="<%= ViewData["rootUri"] %>Content/files/列车员样例表.xls">列车员样例表</a>
					    </li>
				    </ul>			   
			    </div>
                </div>
