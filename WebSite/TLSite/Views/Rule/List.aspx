...
<div class="row">
	<div class="col-xs-12">
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Rule/AddRule">
	                <i class="ace-icon fa fa-plus bigger-120 blue"></i>新增规章
                </a>
		...
		<script type="text/javascript">
			...
			.on('change', function () {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Rule/RetrieveRuleList",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '';
				                rst += '<a class="btn btn-xs btn-info" href="' + rootUri + 'Rule/EditRule/' + o.aData[2] + '">' +
