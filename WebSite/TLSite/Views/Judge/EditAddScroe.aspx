		...
		<form class="form-horizontal" role="form" id="validation-form">
				...
				<div class="col-sm-3">
                    <div class="clearfix">
						<div class="input-group col-xs-10 col-sm-1">
							<input class="date-picker" id="checktime" name="checktime" type="text" data-date-format="yyyy-mm-dd" value="<%=String.Format("{0:yyyy-MM-dd}",  judgeinfo.checktime) %>" />
            ...
            <div class="form-group">
				...
				<div class="col-sm-3">
                    ...
                    <input id="groupname" name="groupname" style="display:none" value="<%= judgeinfo.groupname%>"/>
				</div>
	    ...
	    function changeCrewList() {
	        ...
	        $.ajax({
	            ...
	            success: function (data) {
	                ...
	                if (data.length > 0) {
	                    for (var i = 0; i < data.length; i++) {
	                        if (data[i].uid==<%=judgeinfo.crewid %>) {
	                        rhtml += "<option value='" + data[i].uid + "' selected>" + data[i].realname + " (" + data[i].rolename + ")</option>";
                            }
                            else{
