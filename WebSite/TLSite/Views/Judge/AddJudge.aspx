	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" id="validation-form">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="starttime">出乘日期<span class="red">*</span>：</label>
				<div class="col-sm-3">
                    <div class="clearfix">
				...
				<label class="col-sm-1 control-label no-padding-right" for="checktime">检查日期<span class="red">*</span>：</label>
				<div class="col-sm-3">
                    <div class="clearfix">
						<div class="input-group col-xs-10 col-sm-5">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <div class="">
                    <textarea class="form-control" id="contents" name="contents" style="height:260px; width:600px;"><% if (ViewData["contents"] != null) { %><%= ViewData["contents"] %> <% } %></textarea>
                    </div>
				</div>
			</div>
			<div class="form-group">
	...
	<script type="text/javascript">
		      ...
		      tbl = $('#tbldata').dataTable({
		          ...
		          "aoColumnDefs": [{
		              ...
		              fnRender: function (o, v) {   // o, v contains the object and value for the column
		                  var rst = '<a class="btn btn-xs btn-danger" onclick="processDel(' + o.aData[14] + ')">' +
	            ...
	            success: function (data) {
	                if (data == "") {
                        ...
                        if (tbl != null) {
                            ...
                            oSettings.sAjaxSource = rootUri + "Judge/GetStoreList/?getTimestamp=" + getTimestamp;
                            tbl.fnClearTable(0);
                            tbl.fnDraw();
	                    }
	                } else {
	    ...
	    function changeGroupList() {
            ...
            if (teamid == "" || teamid == null) {
                ...
                $.ajax({
                    type: "GET",
                    url: rootUri + "Judge/FindGroupListOfTeamAdditionDailyGroup/" + teamid,
                    dataType: "json",
                    data: {
                        starttime: starttime
                    },
