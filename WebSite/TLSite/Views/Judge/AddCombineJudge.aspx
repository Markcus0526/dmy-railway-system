	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" id="validation-form">
			<div class="form-group">
                ...
                <label class="col-sm-2 control-label no-padding-right" >检查级别<span class="red">*</span>：</label>
				<div class="col-sm-1">
                    <div class="clearfix">
            ...
            <div class="form-group" >
                <label class="col-sm-3 control-label no-padding-right" >检查部门<span class="red">*</span>：</label>
				<div class="col-sm-3">
                    <div class="clearfix">
                        ...
                        <input class="duanup" id="checkersecname" name="checkersecname" value="" style=""/>

                    </div>
				</div>
				<label class="col-sm-1 control-label no-padding-right" for="relcrewid">检查人<span class="red">*</span>：</label>
				<div class="col-sm-2">
                    <div class="clearfix" id="">
						<select class="" id="checkernameList" name="checkernameList" data-placeholder="请选择..." style="width:180px;display:none" >
				        </select>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
                    <div class="clearfix">
						<select class="select2" id="groupid" name="groupid" data-placeholder="请选择班组" onchange="lockTrainno()" >
				        </select>
                    </div>
				</div>
			</div>
            <div class="form-group" >
                <label class="col-sm-3 control-label no-padding-right" >责任部门<span class="red">*</span>：</label>
				<div class="col-sm-2">
                    <div class="clearfix">
                        <input id="crewsector" name="crewsector" value=""/>
                    </div>
				</div>
				<label class="col-sm-2 control-label no-padding-right" for="relcrewid">责任人<span class="red">*</span>：</label>
				<div class="col-sm-1">
                    <div class="clearfix" id="Div1">
                        <input id="crewname" name="crewname" value=""/>
                    </div>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="company">问题描述<span class="red">*</span>：</label>
				<div class="col-sm-9">
                    <div class="clearfix">
        ...
        <div class="clearfix form-actions">
			<div class="col-md-offset-3 col-md-9">
				<button class="btn btn-info loading-btn" onclick="return submitstorelist()" data-loading-text="提交中...">
					<i class="ace-icon fa fa-check bigger-110"></i>
					确认提交
				</button>
			</div>
    ...
    <script type="text/javascript">
	    ...
	    function redirectToListPage(status) {
	        if (status.indexOf("error") != -1) {
	            ...
	            $('.loading-btn').button('reset');
	            //window.location = rootUri + "Judge/AddCombineJudge";
	        }
	    }
	    ...
	    jQuery(function ($) {
	        $('.btnAdd')
		      ...
		      tbl = $('#tbldata').dataTable({
		          "bServerSide": true,
		          "bProcessing": true,
		          "sAjaxSource": rootUri + "Judge/GetStoreListofCombine",
		          "bFilter": false,
		          "oLanguage": {
	        ...
	        $('#checktime').datepicker({ autoclose: true, todayHighlight: true, language: "zh-CN" })
			.on('change', function () {
			    changeTeamList();
			    //$(this).closest('form').validate().element($(this));
			});
	        ...
	        $('.sec').change(function () {
	            ...
	            $("#checkersecname").attr("value", $(this).children('option:selected').text());
	            aaa();
	        });
	    ...
	    function submitform() {
	        $.ajax({
	            type: "POST",
	            url: rootUri + "Judge/SubmitCombineJudge",
	            dataType: "json",
	            ...
	            success: function (data) {
	                if (data == "") {
                        ...
                        if (tbl != null) {
                            ...
                            oSettings.sAjaxSource = rootUri + "Judge/GetStoreListofCombine/?getTimestamp=" + getTimestamp;
                            tbl.fnClearTable(0);
                            tbl.fnDraw();
	                    }
	                } else {
        ...
        function submitstorelist(){
            if (confirm("请确认输入的内容，一旦提交信息不能再来修改！")) {
                $.ajax({
                    url: rootUri + "Judge/SubmitJudgeofCombine",
                    type: "get",
                    success: function () {
                        alert("考核提交成功！");
                        $('.loading-btn').button('reset');
