	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" id="validation-form">
            ...
            <div class="form-group">
                ...
                <%if (ViewData["editable"] != null && userrole != null && ((string)userrole).Contains("Judge"))
                  {
	...
	<script type="text/javascript">
	    ...
	    jQuery(function ($) {
			...
			.dataTable({
			    ...
			    "bFilter": false,
			    "bLengthChange": false,
			    "sAjaxSource": rootUri + "Duty/RetrieveDutyCrewList/" + $("#uid").val(),
			    "oLanguage": {
			    ...
			    "aoColumnDefs": [
				    {
				        ...
				        fnRender: function (o, v) {   // o, v contains the object and value for the column
				            var rst = '<a class="btn btn-xs btn-danger" onclick="processDel(' + o.aData[4] + ')">' +
        ...
        function forbid(uid) {
            ...
            $.ajax({
                type: "GET",
                url: rootUri + "Duty/changeforbidable/?uid=" + uid + "&getTimestamp=" + getTimestamp,
                dataType: "json",
                success: function (data) {
                    if (data == "") {
                        toastr.options = {
