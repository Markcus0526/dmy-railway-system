		...
		<form class="form-horizontal" role="form" id="validation-form">
            <div class="form-group">
                ...
                <div class="btn-group" style="float:right">
				    <a class="btn btn-info btn-white" href="<%= ViewData["rootUri"] %>Content/files/项点信息-扣分.xls">下载xls导入格式</a>	
				    ...
				    <ul class="dropdown-menu dropdown-info dropdown-menu-right">
					    <li>
						    <a href="<%= ViewData["rootUri"] %>Content/files/项点信息-扣分.xls">扣分模板</a>
					    </li>
					    <li>
						    <a href="<%= ViewData["rootUri"] %>Content/files/项点信息-加分.xls">加分模板</a>
					    </li>
				    </ul>
			    </div>
                </div>
...
// 	                }
	    ...
	    function submitform() {
	        $.ajax({
	            type: "POST",
	            url: rootUri + "Check/SubmitCheckImport",
	            dataType: "json",
