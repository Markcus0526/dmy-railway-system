...
<div class="row">
	<div class="col-xs-12">
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Exam/AddTeamExamBook">
	                <i class="ace-icon fa fa-plus bigger-120 blue"></i>添加试卷
                </a>
		...
		<script type="text/javascript">
		    ...
		    jQuery(function ($) {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Exam/RetrieveTeamExamBookList",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Exam/EditExamBook/' + o.aData[4] + '">' +
		            ...
		            bootbox.dialog({
		                ...
		                buttons: {
		                    ...
		                    main: {
		                        ...
		                        callback: function () {
		                            $.ajax({
		                                url: rootUri + "Exam/DeleteExamBook",
		                                data: {
		                                    "delids": selected_id
		                                },
		                                type: "post",
