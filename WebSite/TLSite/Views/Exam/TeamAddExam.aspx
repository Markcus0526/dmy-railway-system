				...
				<div class="col-sm-9">
                    <div class="clearfix">
					    <div class="radio" style="display:inline-block">
						    <label>
							    <input name="examkind" type="radio" value="1" class="ace"checked/>
		       ...
		       <div class="form-group" >
		        ...
		        <div class="form-group" >
			        ...
			        <div class="col-sm-2" style="margin:6px 0px;">
                        <div class="clearfix">
    					    <input type="text" id="answerstr" name="answerstr" placeholder="请输入正确答案" class="input-large form-control" <% if (examinfo != null) { %>value="<%= examinfo.answerstr %>"<% } %>/>
                        </div>
			        </div>
