...
<div class="row">
	<div class="col-xs-12">
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Exam/AddExam">
	                <i class="ace-icon fa fa-plus bigger-120 blue"></i>添加试题
                </a>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Exam/ImportExam">
	                <i class="ace-icon fa fa-plus bigger-120 blue"></i>批量导入
                </a>
                <a class="btn btn-white btn-warning btn-bold" style="display:none;" id="btnbatchdel" onclick="processDel();">
                    <i class="ace-icon fa fa-trash-o bigger-120 orange"></i>批量删除
                     ...
                     <label class="control-label" style="margin:6px 0px;" for="examtype">车队：</label>
		...
		<script type="text/javascript">
		    ...
		    jQuery(function ($) {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Exam/RetrieveExamList",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Exam/EditExam/' + o.aData[6] + '">' +
