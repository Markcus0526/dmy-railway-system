...
<% var sectorinfo = (tbl_railsector)ViewData["sectorinfo"]; %>
	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" id="validation-form">
			<div class="form-group" >
				<label class="col-sm-3 control-label no-padding-right" for="sectorname">科室名称：</label>
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="text" id="sectorname" name="sectorname" placeholder="请输入科室名称" class="input-large form-control" <% if (sectorinfo != null) { %>value="<%= sectorinfo.sectorname %>"<% } %> />
                    </div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="text" id="sortid" name="sortid" placeholder="请输入数字" class="input-large form-control col-xs-10 col-sm-5" <% if (sectorinfo != null) { %>value="<%= sectorinfo.sortid %>"<% } else { %>value="1"<% } %>  />
	...
	<script type="text/javascript">
	    function redirectToListPage(status) {
	        if (status.indexOf("error") != -1) {
	            ...
	            window.location = rootUri + "Sector/SectorList";
	        }
	    }
	    jQuery(function ($) {
	        $('.loading-btn')
	    ...
	    function submitform() {
	        $.ajax({
	            type: "POST",
	            url: rootUri + "Sector/SubmitSector",
	            dataType: "json",
	    ...
	    function checkSectorName() {
	        ...
	        $.ajax({
	            async: false,
	            type: "GET",
	            url: rootUri + "Sector/CheckUniqueSectorname",
	            dataType: "json",
	            data: {
