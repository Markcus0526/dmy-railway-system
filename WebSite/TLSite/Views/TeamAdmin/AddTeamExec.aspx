                           ...
                           <%if (ViewData["teamlist"] != null)
                             {
                                 foreach (var n in (List<tbl_railteam>)ViewData["teamlist"])
                                      {
                                     %><option value="<%=n.uid %>"  <%if(userinfo != null && userinfo.execparentid==n.uid){ %>selected <% }  %>><%=n.teamname%></option> <%
                                     }
                                 }%>
				        </select>
                    </div>
	    ...
	    jQuery(function ($) {
	        ...
	        $('#validation-form').validate({
	            ...
	            rules: {
                    ...
                    exectype:{
                    <%if(userinfo==null){%>required: true<%} %>
                    }
                    crewno: {
                        required: true,
                        uniquecrewno: true
...
//        }
       ...
       // alert($('#validation-form').serialize());
	        $.ajax({
	            type: "POST",
	            url: rootUri + "TeamAdmin/SubmitTeamExec",
	            dataType: "json",
