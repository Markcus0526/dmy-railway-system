	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" id="validation-form">
            ...
            <div style="float:right; margin-right:10px;">                   
					<a id="execute" class="btn btn-info loading-btn" onclick="ShowContentDialog()" data-loading-text="提交中...">
...
<div id="dialog-message" class="hide">
    <form class="form-horizontal" role="form" id="form_crew">
        <div class="col-xs-12">
            ...
            请在下方输入人员变动的具体原因
            <textarea class="form-control" id="contents" name="contents" style="height:260px; width:640px;"></textarea>
        </div>
    </form>
</div><!-- #dialog-message -->
</asp:Content>
    ...
    jQuery(function ($) {
		...
		.on('change', function () {
           ...
           tbl=$("#tbldata").dataTable({
                "bServerSide": true,
				"bProcessing": true,
				"sAjaxSource": rootUri + "TeamAdmin/RetrieveSPtransferTable",
				"oLanguage": {
                ...
                "aoColumnDefs": [{
		              ...
		              fnRender: function (o, v) {   // o, v contains the object and value for the column
                                if(o.aData[5]=="已处理"){
                                    ...
                                    var rst = '<a class="btn btn-xs btn-danger" onclick="processDel(' + o.aData[6] + ')">' +
        ...
        function changeuserlist(){
         ...
         function processDel(sel_id) {
          ...
          function ShowContentDialog() {
                var crewid=$("#crewlist").val();                
                getselecteduser(crewid);

                crewdlg = $("#dialog-message").removeClass('hide').dialog({
                modal: true,
                width: 700,
                title: "<div class='widget-header widget-header-small'><h4 class='smaller'>其他原因变动信息录入</h4></div>",
                title_html: true,
                buttons: [
					{
					    text: "上报信息",
					    ...
					    click: function () {
					        ...
					        if (contents!=null&&contents!="") {
					            $.ajax({
					                type: "POST",
					                url: rootUri + "TeamAdmin/AddSpTransfer/",
                                    data:{
                                        crewid : crewid,
                                        oldteamid : $("#currentteam").val(),
                                        contents : contents                              
                                    },
					                dataType: "json",
					                success: function (message) {
        ...
        function getselecteduser(id){
            $.ajax({
			    type: "POST",
			    url: rootUri + "TeamAdmin/GetUserInfo/"+id,
			    dataType: "json",
			    success: function (data) {
                    $("#crewno").val(data.crewno);
                    $("#crewname").val(data.realname);
			    }
		    }); 
        }
</script>
