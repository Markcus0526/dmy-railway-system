...
<div class="row">
	<div class="col-xs-12">
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>System/AddSlide">
		...
		<script type="text/javascript">
		    ...
		    jQuery(function ($) {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "System/RetrieveSlideList",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                return '<img src="' + rootUri + o.aData[2] + '" style="width:180px; height:120px;">';
				            },
				            sClass: 'center'
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'System/EditSlide/' + o.aData[4] + '">' +
		            ...
		            bootbox.dialog({
		                ...
		                buttons: {
		                    ...
		                    main: {
		                        ...
		                        callback: function () {
		                            $.ajax({
		                                url: rootUri + "System/DeleteSlide",
		                                data: {
		                                    "delids": selected_id
		                                },
		                                type: "post",
