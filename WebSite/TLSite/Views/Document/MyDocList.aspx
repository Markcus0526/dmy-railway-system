			...
			<div class="widget-body">
				<div class="widget-main">
					...
					<p>
						...
						<a target="_blank" class="btn btn-sm btn-info" href="<%= ViewData["rootUri"] %>Document/ExportDocument?kind=<%= ViewData["kind"] %>"><i class="fa fa-download"></i> 导出Excel</a>
					</p>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript">
		    ...
		    jQuery(function ($) {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Document/RetrieveMyDocList?kind=<%= ViewData["kind"] %>",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                return '<a href="javascript:(0);">' + o.aData[6] + "</a>";
				            },
				            sClass: 'center'
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Document/Detail/' + o.aData[7] + '">' +
		            ...
		            bootbox.dialog({
		                ...
		                buttons: {
		                    ...
		                    main: {
		                        ...
		                        callback: function () {
		                            $.ajax({
		                                url: rootUri + "Document/DeleteTag",
		                                data: {
		                                    "delids": selected_id
		                                },
		                                type: "post",
		    ...
		    function search_data() {
		        ...
		        oSettings = oTable.fnSettings();
		        oSettings.sAjaxSource = rootUri + "Document/RetrieveMyDocList?kind=<%= ViewData["kind"] %>&starttime=" + starttime + "&endtime=" + endtime;
