			...
			<div class="widget-body">
				<div class="widget-main">
					...
					<p>
						...
						<a target="_blank" class="btn btn-sm btn-info" href="<%= ViewData["rootUri"] %>Document/ExportSentDocument"><i class="fa fa-download"></i> 导出Excel</a>
					</p>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript">
		    ...
		    jQuery(function ($) {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Document/RetrieveSentDocList",
				    "oLanguage": {
		    ...
		    function search_data() {
		        ...
		        oSettings = oTable.fnSettings();
		        oSettings.sAjaxSource = rootUri + "Document/RetrieveSentDocList?kind=<%= ViewData["kind"] %>&starttime=" + starttime + "&endtime=" + endtime;
