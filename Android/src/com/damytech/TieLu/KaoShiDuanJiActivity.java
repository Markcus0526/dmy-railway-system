...
public class KaoShiDuanJiActivity extends Activity {
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId())
            {
                case R.id.imgDuanJiKaoShi_Back:
                    finish();
                    break;
                case R.id.rlDuanJiKaoShi_CheDuiKaoShi:
                    Intent intentCheDui = new Intent(KaoShiDuanJiActivity.this, KaoShiCheDuiActivity.class);
                    startActivity(intentCheDui);
                    finish();
                    break;
                case R.id.rlDuanJiKaoShi_KaoShiFenXi:
                    Intent intentLiShi = new Intent(KaoShiDuanJiActivity.this, KaoShiMuLuActivity.class);
                    startActivity(intentLiShi);
                    finish();
                    break;
            }
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.duanjikaoshi_activity);

        mainLayout = (RelativeLayout)findViewById(R.id.rlDuanJiKaoShiBack);
                ...
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    public void onGlobalLayout() {
                        if (bInitialized == false)
                        {
                            ...
                            ResolutionSet._instance.iterateChild(findViewById(R.id.rlDuanJiKaoShiBack));
                            bInitialized = true;
                        }
                    }
                }
        ...
        CommMgr.commService.GetKaoShiWenTiList(handler, Long.toString(GlobalData.GetUid(KaoShiDuanJiActivity.this)), "0");
    }

    private void initControl()
    {
        imgBack = (ImageView) findViewById(R.id.imgDuanJiKaoShi_Back);
        imgBack.setOnClickListener(onClickListener);

        listData = (ListView) findViewById(R.id.listDuanJiKaoShi_Data);

        rlCheDui = (RelativeLayout) findViewById(R.id.rlDuanJiKaoShi_CheDuiKaoShi);
        rlCheDui.setOnClickListener(onClickListener);
        rlLiShi = (RelativeLayout) findViewById(R.id.rlDuanJiKaoShi_KaoShiFenXi);
    ...
    private void initHandler()
    {
        handler = new JsonHttpResponseHandler()
        {
            ...
            public void onFinish()
            {
                ...
                if (result == 1)
                {
                    adapter = new ItemAdapter(KaoShiDuanJiActivity.this, 0, arrData);
                    listData.setAdapter(adapter);
                }

                if (result == -1)
                    GlobalData.showToast(KaoShiDuanJiActivity.this, getString(R.string.network_error));
            }
        };
    }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            rlBack.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(KaoShiDuanJiActivity.this, KaoShiXiangXiActivity.class);
