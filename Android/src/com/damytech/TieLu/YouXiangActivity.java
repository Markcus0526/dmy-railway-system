...
public class YouXiangActivity extends Activity {
    RelativeLayout mainLayout;
    boolean bInitialized = false;

    private ImageView imgBack = null;
    private ImageView imgNote = null;
    private ImageView imgSend = null;
        ...
        public void onClick(View v) {
            ...
            switch (v.getId())
            {
                case R.id.imgYouXiang_Back:
                    ...
                    break;
                case R.id.imgNote:
                    Intent intent = new Intent(YouXiangActivity.this, YouJianXieXinActivity.class);
                    startActivity(intent);
                    break;
                case R.id.imgSend:
                    Intent intentSend = new Intent(YouXiangActivity.this, YouXiangSendActivity.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.youxiang_activity);
    ...
    private void initControl()
    {
        ...
        imgSend.setOnClickListener(onClickListener);
    ...
    public void onResume()
    {
        ...
        CommMgr.commService.GetEmailList(handler, Long.toString(GlobalData.GetUid(YouXiangActivity.this)));
    }
    ...
    private void initHandler()
    {
        handler = new JsonHttpResponseHandler()
        {
            ...
            public void onSuccess(JSONObject jsonData)
            {
                ...
                CommMgr.commService.parseGetEmailList(jsonData, arrData);
                if (arrData == null)
                    result = -1;
            }
            ...
            public void onFinish()
            {
                ...
                if (result == 1)
                {
                    lblTitle.setText(getString(R.string.shoujianxiang) + "(" + arrData.size() + ")");
                    adapter = new ItemAdapter(YouXiangActivity.this, 0, arrData);
                    listDatas.setAdapter(adapter);
                }

                if (result == -1)
                {
                    GlobalData.showToast(YouXiangActivity.this, getString(R.string.network_error));
                    finish();
                }
            }
        };
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            rlBack.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(YouXiangActivity.this, YouXiangXiangXiActivity.class);
