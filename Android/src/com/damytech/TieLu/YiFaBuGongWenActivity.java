...
public class YiFaBuGongWenActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yifabugongwen_activity);
        ...
        CommMgr.commService.GetGongWenList(handler, "", "", "", "", GlobalData.GetUid(YiFaBuGongWenActivity.this));
    }
    ...
    private void initHandler()
    {
        handler = new JsonHttpResponseHandler()
        {
            ...
            public void onFinish()
            {
                ...
                if (result == 1)
                {
                    adapter = new ItemAdapter(YiFaBuGongWenActivity.this, 0, arrData);
                    listData.setAdapter(adapter);
                }

                if (result == -1)
                    GlobalData.showToast(YiFaBuGongWenActivity.this, getString(R.string.network_error));
            }
        };
    }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            btnDetail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(YiFaBuGongWenActivity.this, GongWenXiangQingActivity.class);
